...
- 검색 기능 추가(검색 아이콘을 통해 검색 가능 & 추후 엔터로 검색 가능 개발 예정)
- 홈화면 바로가기 아이콘 추가
<br/>
...
### back
연결 완료✔<br/>
레시피 API 엔드포인트 주소들 교체 완료 ▶ 현재 검토 중 (6월~)
<br/><br/>

### front
연결 완료✔<br/>
Home 컴포, hooks 파일 API 주소 호스팅 플랫폼 주소로 변경 완료 ▶ 현재 검토 중 (6월~)
<br/><br/>
### 배포 관련 회고 및 성공
